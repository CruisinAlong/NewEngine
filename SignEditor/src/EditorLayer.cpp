...
void EditorLayer::OnEvent(Sign::Event& event)
{
...
bool EditorLayer::OnWindowResizedEvent(Sign::WindowResizedEvent& e)
{
...
bool EditorLayer::OnKeyPressedEvent(Sign::KeyPressedEvent& e)
{
	if (e.IsRepeated())
		return false;
