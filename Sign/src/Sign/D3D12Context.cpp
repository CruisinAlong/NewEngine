...
Sign::D3D12Context::D3D12Context(HWND windowHandle, uint32_t width, uint32_t height) : m_WindowHandle(windowHandle), m_Width(width), m_Height(height)
{
}

void Sign::D3D12Context::Init()
{
	CreateDevice();
	CreateSwapChain();
	CreateRTVHeap();
...
void Sign::D3D12Context::SwapBuffers()
{
...
void Sign::D3D12Context::CreateDevice()
{
...
void Sign::D3D12Context::CreateSwapChain()
{
...
void Sign::D3D12Context::CreateRTVHeap()
{
...
Microsoft::WRL::ComPtr<IDXGIAdapter4> Sign::D3D12Context::GetAdapter(bool useWarp)
{
...
std::shared_ptr<D3D12CommandQueue> Sign::D3D12Context::GetCommandQueue(D3D12_COMMAND_LIST_TYPE type) const
{
